  ...
  <html>
    <head>
      ...
      <style>
        ...
        header {{ 
          background-color: #E41E25; color: white;
        ...
        .flag-icon {{
          ...
          width: 40px; height: 28px; background-color: #E41E25;
          display: flex; justify-content: center; align-items: center;
        }}
        .double-eagle {{ width: 24px; height: 24px; color: #000000; }}
        .content {{ margin: 20px; }}
    ...
    <body>
      ...
      <div class="content">
        <form action="/dictionary/save-entry" method="post">
          <!-- Needed to create a new entry -->
          <input type="hidden" name="original-orth" value=""/>
          ...
          <div class="form-group">
            <label>Parts of Speech (comma-separated):</label>
            <input type="text" name="pos" placeholder="noun, verb, adj"/>
          </div>

          <div class="form-group">
            <label>Definition (general):</label>
            <textarea name="definition" required="required"></textarea>
          </div>

          <div class="form-group">
            <label>Definition (English):</label>
            <textarea name="definition_en"></textarea>
          </div>

          <div class="form-group">
            <label>Definition (French):</label>
            <textarea name="definition_fr"></textarea>
          </div>

          <div class="form-group">
            <label>Definition (Albanian):</label>
            <textarea name="definition_sq"></textarea>
          </div>
